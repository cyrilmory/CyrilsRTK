...
SpectralForwardModelImageFilter<
  ...
  IncidentSpectrumImageType,
  DetectorResponseImageType,
  MaterialAttenuationsImageType>::SetInputDecomposedProjections(const typename itk::ImageBase<DecomposedProjectionsType::ImageDimension> * DecomposedProjections)
{
...
template <unsigned int VNumberOfMaterials>
  ...
  SpectralForwardModelImageFilter<DecomposedProjectionsType,
                                  ...
                                  IncidentSpectrumImageType,
                                  DetectorResponseImageType,
                                  MaterialAttenuationsImageType>::SetInputFixedVectorLengthDecomposedProjections(
    const itk::Image<itk::Vector<DecomposedProjectionsDataType, VNumberOfMaterials>, DecomposedProjectionsType::ImageDimension> * DecomposedProjections)
{
  using ActualInputType = itk::Image<itk::Vector<DecomposedProjectionsDataType, VNumberOfMaterials>, DecomposedProjectionsType::ImageDimension>;
